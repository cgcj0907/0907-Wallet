...
export async function getSTETHBalance(address: string) {
...
export async function sendSTETHPaymasterTransaction(
    keyPath: string,
    password: string,
...
export async function getSTETHTransactions(address: string) {
